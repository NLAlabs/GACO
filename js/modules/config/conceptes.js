/**
 * Configuració i gestió → conceptes. Dades bàsiques i principalment fixes
...
export async function render() {
  ...
  contenidor.innerHTML = '<div class="card"><p>Gestió de conceptes — pendent d\'implementar.</p></div>';
}
