/**
 * Configuració i gestió → comptes-bancaris. Dades bàsiques i principalment fixes
...
export async function render() {
  ...
  contenidor.innerHTML = '<div class="card"><p>Gestió de comptes-bancaris — pendent d\'implementar.</p></div>';
}
